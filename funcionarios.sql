...
-- TRAGA FUNCIONARIOS QUE TRABALHAM NO DEPARTAMENTO DE FILMES OU NO DEPARTAMENTO DE ROUPAS


SELECT COUNT(*) FROM funcionarios WHERE departamento = 'Filmes' OR departamento = 'Roupas';

-- LISTA DE FUNCIONARIAS DO DEPARTAMENTO DE FILMES OU NO DEPARTAMENTO LAR , O GESTOR PRECISA ENVIAR EMAIAL PARA OS FUNCIONARIOS DESTES DOIS SETORES 

  SELECT email FROM funcionarios WHERE  sexo ='Feminino' AND  (departamento ='Filmes' OR departamento='Lar');

-- traga funcionarios do sexo masculino oi os que trabalham no setor jardim 
